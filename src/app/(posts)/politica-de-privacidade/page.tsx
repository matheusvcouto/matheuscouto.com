...
const Page: React.FC<PageProps> = (props) => {
  return (
    <>
      ...
      <p>As informações pessoais que nos são enviadas por meio de nosso site e redes sociais serão utilizadas para os fins desta política, podendo ser:</p>
      <ul>
        ...
        <li>Fornecer informações estatísticas sobre nossos usuários (mas esses terceiros não identificarão nenhum usuário individual a partir dessas informações);</li>
        ...
        <li>Verificar a conformidade com os termos e condições que regem o uso do nosso site (incluindo o monitoramento de mensagens privadas enviadas através do serviço de mensagens privadas do nosso site).</li>
      </ul>
      <p>Se você enviar informações pessoais para publicação em nosso site, publicaremos e usaremos essas informações de acordo com a licença que você nos concedeu. Suas configurações de privacidade podem ser usadas para limitar a publicação de suas informações em nosso site e ajustadas através do uso de privacidade no site. Sem seu consentimento expresso, não forneceremos suas informações pessoais a terceiros para fins de marketing direto por parte deles ou de terceiros.</p>

      <h3>Divulgação de Informações Pessoais</h3>
      <p>Podemos compartilhar suas informações pessoais com nossa equipe e profissionais contratados conforme necessário para os fins desenvolvidos nesta política. Podemos divulgar suas informações pessoais:</p>
      <ul>
        ...
        <li>A qualquer pessoa que acreditarmos que possa solicitar a um tribunal ou outra autoridade competente a divulgação dessas informações pessoais, quando, em nossa opinião razoável, for provável que tal tribunal ou autoridade ordene a divulgação dessas informações pessoais.</li>
      </ul>

      <h3>Transferências Internacionais de Dados</h3>
      <p>Alguns de seus dados pessoais serão transferidos para outros países, por exemplo, quando utilizarmos serviços computacionais em nuvem para processamento ou armazenamento de dados. Neste caso, adotamos todas as medidas legais aplicáveis, em conformidade com a Lei Geral de Proteção de Dados (LGPD) e suas regulamentações futuras, garantindo a proteção e privacidade dos seus dados pessoais.</p>

      <h3>Retenção de Informações Pessoais</h3>
      <p>As informações pessoais que processamos para qualquer propósito ou propósitos não devem ser mantidas por mais tempo do que o necessário para esse propósito ou propósitos. Reteremos documentos (incluindo documentos eletrônicos) que contêm dados pessoais:</p>
      <ul>
        <li>Na medida em que somos obrigados a fazê-lo por lei;</li>
      ...
      <ul>
        <li>Armazenaremos todas as suas informações pessoais fornecidas em nossos servidores seguros (protegidos por senha e firewall);</li>
        <li>Todas as transações financeiras eletrônicas realizadas através do nosso site serão protegidas por tecnologia de criptografia;</li>
        <li>Você reconhece que a transmissão de informações pela internet é inerentemente insegura e que não podemos garantir a segurança dos dados enviados pela internet;</li>
        <li>Você é responsável por manter em sigilo a senha usada para acessar nosso site; não solicitaremos sua senha (exceto quando você fizer login em nosso site).</li>
      </ul>

      <h3>Seus Direitos</h3>
      <p>Você pode solicitar o fornecimento de qualquer informação pessoal que detenhamos e também o não processamento de suas informações pessoais para fins de marketing. Além das informações disponibilizadas nesta Política de Privacidade, você pode também exercer os direitos de acordo com a Lei Geral de Proteção de Dados, entre eles:</p>
      <ul>
        ...
        <li>Eliminação dos dados pessoais tratados com o consentimento ou desnecessários, excessivos ou quando entender que algum ponto da LGPD não foi atendido;</li>
        <li>Informação sobre as hipóteses e com quais empresas, parceiros e outras instituições podemos compartilhar, ou receber dados referentes a você;</li>
        <li>Informação sobre a possibilidade de não fornecer e sobre as consequências da negativa, quando aplicável.</li>
      </ul>
      <p>Todas as solicitações serão tratadas de forma gratuita e serão submetidas a uma avaliação prévia da sua identidade e da viabilidade do atendimento, a fim de cumprir com obrigações que impeçam o atendimento completo das requisições dos titulares de direito.</p>
      ...
      <h3>Cookies</h3>
      <p>Nosso site usa cookies, um pequeno arquivo adicionado ao dispositivo do usuário para fornecer uma experiência personalizada de acesso à plataforma. Os cookies analisam o tráfego de internet e nos permitem saber quando o usuário visita um site específico, mas não dão acesso a um computador ou revelam informações além dos dados que o usuário escolhe compartilhar conosco.</p>
